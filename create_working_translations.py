...
def create_working_html_file(file_path):
    """Create a working HTML file with proper inline translations"""
    print(f"Creating working {file_path}...")
    ...
    # Create a clean HTML structure with working inline translations
...
{body_content}
    ...
    <script>
        ...
        // WORKING TRANSLATIONS - INLINE AND COMPLETE
        ...
        // Apply language changes - THIS IS THE KEY FUNCTION
        function applyLanguage(language) {{
            ...
            elements.forEach(element => {{
                ...
                if (langData[key]) {{
                    ...
                    console.log('Translated:', key, 'to:', langData[key]);
                }} else {{
    ...
    print(f"✅ Created working {file_path}")

# Create working HTML files for all pages
html_files = [
...
for file_path in html_files:
    if os.path.exists(file_path):
        create_working_html_file(file_path)
    else:
        print(f"File not found: {file_path}")

print("✅ All HTML files created with WORKING translations!")
